<?php
/**
 * The file that defines the devices controller class
 *
...
/**
 * The devices controller class.
 *
 * This is used to define devices controller class.
 *
 * @package    NgSurvey
 ...
 * @since      1.0.0
 */
class NgSurvey_Controller_Devices extends NgSurvey_Controller {
	...
	public function display () {
        ...
        $reports_model = $this->get_model( 'devices' );
