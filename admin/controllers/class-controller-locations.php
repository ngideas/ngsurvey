<?php
/**
 * The file that defines the locations controller class
 *
...
/**
 * The locations controller class.
 *
 * This is used to define locations controller class.
 *
 * @package    NgSurvey
 ...
 * @since      1.0.0
 */
class NgSurvey_Controller_Locations extends NgSurvey_Controller {
	...
	public function display () {
        ...
        $reports_model = $this->get_model( 'locations' );
